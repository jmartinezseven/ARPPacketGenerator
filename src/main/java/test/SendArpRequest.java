...
public class SendArpRequest {
    ...
    private static final MacAddress SRC_MAC_ADDR
            = MacAddress.getByName("80:86:f2:ad:cb:72");
    ...
    public static void main(String[] args) throws PcapNativeException, NotOpenException {
        String strSrcIpAddress = "192.168.0.3"; // for InetAddress.getByName()
        String strDstIpAddress = "192.168.0.4"; // for InetAddress.getByName()
        ...
        try {
            ...
            try {
                arpBuilder
                        ...
                        .dstHardwareAddr(MacAddress.getByName("B4:74:43:C7:3C:F1"))
            ...
            etherBuilder.dstAddr(MacAddress.getByName("B4:74:43:C7:3C:F1"))
